...
class vProperty extends vObject {
     ...
     *
     * @param HeapLines $heapLines The string from the myComponent which contains this property.
     */
     ...
     * happened when myComponent::ParseFrom() called myComponent::UnwrapComponent().
     *
     * @param string $propstring The string from the myComponent which contains this property.
     */
    function ParseFrom( &$unescaped ) {
        //$this->rendered = $heapLines;
